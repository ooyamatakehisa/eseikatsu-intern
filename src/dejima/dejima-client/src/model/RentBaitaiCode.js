...
/**
* Enum class RentBaitaiCode.
* @enum {}
* @readonly
*/
export default class RentBaitaiCode {
    ...
    /**
    * Returns a <code>RentBaitaiCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RentBaitaiCode} The enum <code>RentBaitaiCode</code> value.
    */

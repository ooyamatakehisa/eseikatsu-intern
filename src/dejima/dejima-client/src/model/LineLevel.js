...
/**
* Enum class LineLevel.
* @enum {}
* @readonly
*/
export default class LineLevel {
    ...
    /**
    * Returns a <code>LineLevel</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/LineLevel} The enum <code>LineLevel</code> value.
    */

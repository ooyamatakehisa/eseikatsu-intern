...
/**
 * The LineAggregateElem model module.
 * @module model/LineAggregateElem
 * @version 9.0.0
 */
class LineAggregateElem {
    /**
     * Constructs a new <code>LineAggregateElem</code>.
     * 駅・沿線別集計小計
     * @alias module:model/LineAggregateElem
     * @param count {Number} 物件数
     * @param code {Number} コード値
     * @param name {String} 名前
     */
    constructor(count, code, name) { 
        
        LineAggregateElem.initialize(this, count, code, name);
    }
     ...
     */
    static initialize(obj, count, code, name) { 
        obj['count'] = count;
        obj['code'] = code;
        obj['name'] = name;
    }
    ...
    /**
     * Constructs a <code>LineAggregateElem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineAggregateElem} obj Optional instance to populate.
     * @return {module:model/LineAggregateElem} The populated <code>LineAggregateElem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineAggregateElem();
            ...
            if (data.hasOwnProperty('parent_code')) {
                obj['parent_code'] = ApiClient.convertToType(data['parent_code'], 'Number');
            }
 ...
 * @member {Number} count
 */
LineAggregateElem.prototype['count'] = undefined;

/**
 * ドリルダウン用クエリパラメータ
 * @member {String} query
 */
LineAggregateElem.prototype['query'] = undefined;

/**
 * コード値
 * @member {Number} code
 */
LineAggregateElem.prototype['code'] = undefined;

/**
 * 名前
 * @member {String} name
 */
LineAggregateElem.prototype['name'] = undefined;

/**
 * 親のコード値
 * @member {Number} parent_code
 */
LineAggregateElem.prototype['parent_code'] = undefined;

/**
 * 親の名前
 * @member {String} parent_name
 */
LineAggregateElem.prototype['parent_name'] = undefined;
...
export default LineAggregateElem;

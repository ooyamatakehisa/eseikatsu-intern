...
/**
 * The BusStopAccess model module.
 * @module model/BusStopAccess
 * @version 9.0.0
 */
class BusStopAccess {
    /**
     * Constructs a new <code>BusStopAccess</code>.
     * バス停からの移動距離・所要時間  単位はm（徒歩距離の場合）か分（徒歩時間の場合）
     * @alias module:model/BusStopAccess
     */
    constructor() { 
        
        BusStopAccess.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BusStopAccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BusStopAccess} obj Optional instance to populate.
     * @return {module:model/BusStopAccess} The populated <code>BusStopAccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BusStopAccess();
            ...
            if (data.hasOwnProperty('bus_line_name')) {
                obj['bus_line_name'] = ApiClient.convertToType(data['bus_line_name'], 'String');
            }
            if (data.hasOwnProperty('bus_stop_name')) {
                obj['bus_stop_name'] = ApiClient.convertToType(data['bus_stop_name'], 'String');
            }
            if (data.hasOwnProperty('riding_time')) {
                obj['riding_time'] = ApiClient.convertToType(data['riding_time'], ValueWithUnit);
            }
        }
        return obj;
    }
 ...
 * @member {Number} value
 */
BusStopAccess.prototype['value'] = undefined;

/**
 * @member {String} unit
 */
BusStopAccess.prototype['unit'] = undefined;

/**
 * @member {String} bus_line_name
 */
BusStopAccess.prototype['bus_line_name'] = undefined;

/**
 * @member {String} bus_stop_name
 */
BusStopAccess.prototype['bus_stop_name'] = undefined;

/**
 * 最寄り駅からのバス乗車時間
 * @member {module:model/ValueWithUnit} riding_time
 */
BusStopAccess.prototype['riding_time'] = undefined;

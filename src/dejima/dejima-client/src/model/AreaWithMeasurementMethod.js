...
/**
 * The AreaWithMeasurementMethod model module.
 * @module model/AreaWithMeasurementMethod
 * @version 9.0.0
 */
class AreaWithMeasurementMethod {
    /**
     * Constructs a new <code>AreaWithMeasurementMethod</code>.
     * 計測方法付き面積
     * @alias module:model/AreaWithMeasurementMethod
     * @param area {Number} 
     * @param measurementMethod {String} 
     */
    constructor(area, measurementMethod) { 
        
        AreaWithMeasurementMethod.initialize(this, area, measurementMethod);
    }
     ...
     */
    static initialize(obj, area, measurementMethod) { 
        obj['area'] = area;
        obj['measurement_method'] = measurementMethod;
    }

    /**
     * Constructs a <code>AreaWithMeasurementMethod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AreaWithMeasurementMethod} obj Optional instance to populate.
     * @return {module:model/AreaWithMeasurementMethod} The populated <code>AreaWithMeasurementMethod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AreaWithMeasurementMethod();

            if (data.hasOwnProperty('area')) {
                obj['area'] = ApiClient.convertToType(data['area'], 'Number');
            }
            if (data.hasOwnProperty('measurement_method')) {
                obj['measurement_method'] = ApiClient.convertToType(data['measurement_method'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {Number} area
 */
AreaWithMeasurementMethod.prototype['area'] = undefined;

/**
 * @member {String} measurement_method
 */
AreaWithMeasurementMethod.prototype['measurement_method'] = undefined;
...
export default AreaWithMeasurementMethod;

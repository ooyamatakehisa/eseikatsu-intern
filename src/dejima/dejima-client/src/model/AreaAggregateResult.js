...
import AreaAggregateElem from './AreaAggregateElem';

/**
 * The AreaAggregateResult model module.
 * @module model/AreaAggregateResult
 * @version 9.0.0
 */
class AreaAggregateResult {
    /**
     * Constructs a new <code>AreaAggregateResult</code>.
     * エリア別集計結果
     * @alias module:model/AreaAggregateResult
     * @param results {Array.<module:model/AreaAggregateElem>} 集計結果
     */
    constructor(results) { 
        
        AreaAggregateResult.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>AreaAggregateResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AreaAggregateResult} obj Optional instance to populate.
     * @return {module:model/AreaAggregateResult} The populated <code>AreaAggregateResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AreaAggregateResult();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [AreaAggregateElem]);
            }
        }
        return obj;
    }
...
/**
 * 集計結果
 * @member {Array.<module:model/AreaAggregateElem>} results
 */
AreaAggregateResult.prototype['results'] = undefined;
...
export default AreaAggregateResult;

...
import RentExternalUrl from './RentExternalUrl';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('external_url')) {
                obj['external_url'] = ApiClient.convertToType(data['external_url'], [RentExternalUrl]);
            }
...
/**
 * @member {Array.<module:model/RentExternalUrl>} external_url
 */
RentProperty.prototype['external_url'] = undefined;

...
class Deposit {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('additional_deposit')) {
                obj['additional_deposit'] = ApiClient.convertToType(data['additional_deposit'], PriceWithUnit);
            }
            if (data.hasOwnProperty('additional_deposit_reason')) {
                obj['additional_deposit_reason'] = ApiClient.convertToType(data['additional_deposit_reason'], 'String');
            }
        }
        return obj;
    }
 ...
 */
Deposit.prototype['is_tax_included'] = undefined;

/**
 * @member {Boolean} is_non_taxable
 */
Deposit.prototype['is_non_taxable'] = undefined;

/**
 * @member {String} unit
 */
Deposit.prototype['unit'] = undefined;

/**
 * 積増し敷金
 * @member {module:model/PriceWithUnit} additional_deposit
 */
Deposit.prototype['additional_deposit'] = undefined;

/**
 * @member {String} additional_deposit_reason
 */
Deposit.prototype['additional_deposit_reason'] = undefined;

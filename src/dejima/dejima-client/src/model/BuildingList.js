...
/**
 * The BuildingList model module.
 * @module model/BuildingList
 * @version 9.0.0
 */
class BuildingList {
    /**
     * Constructs a new <code>BuildingList</code>.
     * 建物概要一覧
     * @alias module:model/BuildingList
     * @param totalCounts {Number} 件数
     * @param startIndex {Number} 検索の開始インデックス
     * @param itemsPerPage {Number} ページあたりの最大表示数
     * @param results {Array.<module:model/BuildingPreview>} 建物概要
     */
    constructor(totalCounts, startIndex, itemsPerPage, results) { 
        
        BuildingList.initialize(this, totalCounts, startIndex, itemsPerPage, results);
    }
    ...
    /**
     * Constructs a <code>BuildingList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildingList} obj Optional instance to populate.
     * @return {module:model/BuildingList} The populated <code>BuildingList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildingList();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [BuildingPreview]);
            }
        }
        return obj;
    }
 ...
 */
BuildingList.prototype['total_counts'] = undefined;

/**
 * 検索の開始インデックス
 * @member {Number} start_index
 */
BuildingList.prototype['start_index'] = undefined;

/**
 * ページあたりの最大表示数
 * @member {Number} items_per_page
 */
BuildingList.prototype['items_per_page'] = undefined;

/**
 * 建物概要
 * @member {Array.<module:model/BuildingPreview>} results
 */
BuildingList.prototype['results'] = undefined;

...
/**
 * The CarAccess model module.
 * @module model/CarAccess
 * @version 9.0.0
 */
class CarAccess {
    /**
     * Constructs a new <code>CarAccess</code>.
     * 車での移動距離・所要時間
     * @alias module:model/CarAccess
     * @param distance {Number} 
     * @param minutes {Number} 
     */
    constructor(distance, minutes) { 
        
        CarAccess.initialize(this, distance, minutes);
    }
     ...
     */
    static initialize(obj, distance, minutes) { 
        obj['distance'] = distance;
        obj['minutes'] = minutes;
    }

    /**
     * Constructs a <code>CarAccess</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CarAccess} obj Optional instance to populate.
     * @return {module:model/CarAccess} The populated <code>CarAccess</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CarAccess();
 ...
 */
CarAccess.prototype['distance'] = undefined;

/**
 * @member {Number} minutes
 */
CarAccess.prototype['minutes'] = undefined;

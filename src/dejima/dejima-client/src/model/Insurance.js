...
class Insurance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('insurance_month')) {
                obj['insurance_month'] = ApiClient.convertToType(data['insurance_month'], 'Number');
            }
            if (data.hasOwnProperty('insurance_name')) {
                obj['insurance_name'] = ApiClient.convertToType(data['insurance_name'], 'String');
            }
            if (data.hasOwnProperty('insurance_comment')) {
                obj['insurance_comment'] = ApiClient.convertToType(data['insurance_comment'], 'String');
            }
            if (data.hasOwnProperty('insurance_price')) {
                obj['insurance_price'] = ApiClient.convertToType(data['insurance_price'], Price);
            }
        }
        return obj;
    }
...
/**
 * @member {Number} insurance_month
 */
Insurance.prototype['insurance_month'] = undefined;

/**
 * @member {String} insurance_name
 */
Insurance.prototype['insurance_name'] = undefined;

/**
 * @member {String} insurance_comment
 */
Insurance.prototype['insurance_comment'] = undefined;

/**
 * 損保料金
 * @member {module:model/Price} insurance_price
 */
Insurance.prototype['insurance_price'] = undefined;

...
/**
 * The RentReform model module.
 * @module model/RentReform
 * @version 9.0.0
 */
class RentReform {
    /**
     * Constructs a new <code>RentReform</code>.
     * 賃貸リフォーム情報
     * @alias module:model/RentReform
     */
    constructor() { 
        
        RentReform.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RentReform</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RentReform} obj Optional instance to populate.
     * @return {module:model/RentReform} The populated <code>RentReform</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RentReform();

            if (data.hasOwnProperty('reform_detail')) {
                obj['reform_detail'] = ApiClient.convertToType(data['reform_detail'], 'String');
            }
            if (data.hasOwnProperty('reform_datejun')) {
                obj['reform_datejun'] = ApiClient.convertToType(data['reform_datejun'], DateJun);
            }
        }
        return obj;
    }
...
/**
 * @member {String} reform_detail
 */
RentReform.prototype['reform_detail'] = undefined;

/**
 * リフォーム実施日
 * @member {module:model/DateJun} reform_datejun
 */
RentReform.prototype['reform_datejun'] = undefined;

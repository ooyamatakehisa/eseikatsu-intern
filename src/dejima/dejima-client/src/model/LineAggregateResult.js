...
import LineAggregateElem from './LineAggregateElem';

/**
 * The LineAggregateResult model module.
 * @module model/LineAggregateResult
 * @version 9.0.0
 */
class LineAggregateResult {
    /**
     * Constructs a new <code>LineAggregateResult</code>.
     * 駅・沿線別集計結果
     * @alias module:model/LineAggregateResult
     * @param level {String} 集計のレベル
     * @param results {Array.<module:model/LineAggregateElem>} 集計結果
     */
    constructor(level, results) { 
        
        LineAggregateResult.initialize(this, level, results);
    }
     ...
     */
    static initialize(obj, level, results) { 
        obj['level'] = level;
        obj['results'] = results;
    }

    /**
     * Constructs a <code>LineAggregateResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LineAggregateResult} obj Optional instance to populate.
     * @return {module:model/LineAggregateResult} The populated <code>LineAggregateResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LineAggregateResult();

            if (data.hasOwnProperty('level')) {
                obj['level'] = ApiClient.convertToType(data['level'], 'String');
            }
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [LineAggregateElem]);
            }
        }
        return obj;
    }
 ...
 * @member {String} level
 */
LineAggregateResult.prototype['level'] = undefined;

/**
 * 集計結果
 * @member {Array.<module:model/LineAggregateElem>} results
 */
LineAggregateResult.prototype['results'] = undefined;
...
export default LineAggregateResult;

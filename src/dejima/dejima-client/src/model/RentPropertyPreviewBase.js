...
/**
 * The RentPropertyPreviewBase model module.
 * @module model/RentPropertyPreviewBase
 * @version 9.0.0
 */
class RentPropertyPreviewBase {
    /**
     * Constructs a new <code>RentPropertyPreviewBase</code>.
     * 賃貸物件概要
     * @alias module:model/RentPropertyPreviewBase
    ...
    /**
     * Constructs a <code>RentPropertyPreviewBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RentPropertyPreviewBase} obj Optional instance to populate.
     * @return {module:model/RentPropertyPreviewBase} The populated <code>RentPropertyPreviewBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RentPropertyPreviewBase();
 ...
 */
RentPropertyPreviewBase.prototype['property_full_key'] = undefined;

/**
 * @member {String} property_class
 */
RentPropertyPreviewBase.prototype['property_class'] = undefined;

/**
 * 1: 土地<br/>2: 建物<br/>3: 区画<br/>4: 建物付帯設備
 * @member {Number} property_class_code
 */
RentPropertyPreviewBase.prototype['property_class_code'] = undefined;

/**
 * @member {String} property_use
 */
RentPropertyPreviewBase.prototype['property_use'] = undefined;

/**
 * 1: 居住用<br/>2: 事業用<br/>3: 投資用
 * @member {Number} property_use_code
 */
RentPropertyPreviewBase.prototype['property_use_code'] = undefined;

/**
 * @member {String} property_type
 */
RentPropertyPreviewBase.prototype['property_type'] = undefined;
 ...
 */
RentPropertyPreviewBase.prototype['property_type_code'] = undefined;

/**
 * @member {String} room_number_text
 */
RentPropertyPreviewBase.prototype['room_number_text'] = undefined;

/**
 * @member {Boolean} is_published
 */
RentPropertyPreviewBase.prototype['is_published'] = undefined;

/**
 * @member {Date} published_datetime
 */
RentPropertyPreviewBase.prototype['published_datetime'] = undefined;

/**
 * @member {Date} last_update_datetime
 */
RentPropertyPreviewBase.prototype['last_update_datetime'] = undefined;

/**
 * @member {Date} next_renewal_datetime
 */
RentPropertyPreviewBase.prototype['next_renewal_datetime'] = undefined;

/**
 * @member {Boolean} has_entries
 */
RentPropertyPreviewBase.prototype['has_entries'] = undefined;

/**
 * @member {String} current_status
 */
RentPropertyPreviewBase.prototype['current_status'] = undefined;

/**
 * 1: 居住中<br/>2: 空室<br/>3: 建築中<br/>4: 退去予定<br/>5: 改装中<br/>6: 完成済
 * @member {Number} current_status_code
 */
RentPropertyPreviewBase.prototype['current_status_code'] = undefined;

/**
 * @member {Boolean} name_display_flag
 */
RentPropertyPreviewBase.prototype['name_display_flag'] = undefined;

/**
 * @member {Boolean} room_number_display_flag
 */
RentPropertyPreviewBase.prototype['room_number_display_flag'] = undefined;

/**
 * @member {Boolean} branch_number_display_flag
 */
RentPropertyPreviewBase.prototype['branch_number_display_flag'] = undefined;

/**
 * @member {Boolean} map_marker_display_flag
 */
RentPropertyPreviewBase.prototype['map_marker_display_flag'] = undefined;

/**
 * @member {Boolean} panorama_flag
 */
RentPropertyPreviewBase.prototype['panorama_flag'] = undefined;

/**
 * @member {Boolean} house_with_office_flag
 */
RentPropertyPreviewBase.prototype['house_with_office_flag'] = undefined;

/**
 * @member {Boolean} house_with_shops_flag
 */
RentPropertyPreviewBase.prototype['house_with_shops_flag'] = undefined;

/**
 * @member {Boolean} it_jusetsu_flag
 */
RentPropertyPreviewBase.prototype['it_jusetsu_flag'] = undefined;

/**
 * @member {String} gas
 */
RentPropertyPreviewBase.prototype['gas'] = undefined;

/**
 * 1: 都市ガス<br/>2: プロパン<br/>3: 共同<br/>4: その他
 * @member {Number} gas_code
 */
RentPropertyPreviewBase.prototype['gas_code'] = undefined;

/**
 * @member {String} rent_transaction_form
 */
RentPropertyPreviewBase.prototype['rent_transaction_form'] = undefined;

/**
 * 1: 貸主<br/>2: 代理<br/>3: 仲介元付(専任)<br/>4: 仲介元付(一般)<br/>5: 仲介先物<br/>6: 仲介元付<br/>7: 仲介
 * @member {Number} rent_transaction_form_code
 */
RentPropertyPreviewBase.prototype['rent_transaction_form_code'] = undefined;

/**
 * @member {String} residence_rent_period
 */
RentPropertyPreviewBase.prototype['residence_rent_period'] = undefined;

/**
 * @member {Number} residence_rent_period_code
 */
RentPropertyPreviewBase.prototype['residence_rent_period_code'] = undefined;

/**
 * @member {String} new_used
 */
RentPropertyPreviewBase.prototype['new_used'] = undefined;

/**
 * @member {Number} new_used_code
 */
RentPropertyPreviewBase.prototype['new_used_code'] = undefined;

/**
 * 現貸料
 * @member {module:model/Price} price
 */
RentPropertyPreviewBase.prototype['price'] = undefined;

/**
 * @member {Number} price_per_tsubo
 */
RentPropertyPreviewBase.prototype['price_per_tsubo'] = undefined;

/**
 * @member {Date} price_update_date
 */
RentPropertyPreviewBase.prototype['price_update_date'] = undefined;

/**
 * 雑費
 * @member {module:model/PriceWithUnit} misc_expense
 */
RentPropertyPreviewBase.prototype['misc_expense'] = undefined;

/**
 * @member {Boolean} has_insurance
 */
RentPropertyPreviewBase.prototype['has_insurance'] = undefined;

/**
 * @member {module:model/Insurance} insurance
 */
RentPropertyPreviewBase.prototype['insurance'] = undefined;

/**
 * 礼金
 * @member {module:model/PriceWithUnit} key_money
 */
RentPropertyPreviewBase.prototype['key_money'] = undefined;

/**
 * @member {module:model/Deposit} deposit
 */
RentPropertyPreviewBase.prototype['deposit'] = undefined;

/**
 * 敷引金
 * @member {module:model/PriceWithUnit} repair_cost
 */
RentPropertyPreviewBase.prototype['repair_cost'] = undefined;

/**
 * 保証金
 * @member {module:model/PriceWithUnit} guarantee_price
 */
RentPropertyPreviewBase.prototype['guarantee_price'] = undefined;

/**
 * 償却金
 * @member {module:model/PriceWithUnit} amortization_expense
 */
RentPropertyPreviewBase.prototype['amortization_expense'] = undefined;

/**
 * 権利金
 * @member {module:model/PriceWithUnit} premium
 */
RentPropertyPreviewBase.prototype['premium'] = undefined;

/**
 * 管理費
 * @member {module:model/PriceWithUnit} manage_cost
 */
RentPropertyPreviewBase.prototype['manage_cost'] = undefined;

/**
 * 共益費
 * @member {module:model/PriceWithUnit} service_fee
 */
RentPropertyPreviewBase.prototype['service_fee'] = undefined;

/**
 * @member {Boolean} is_tokuyuchin
 */
RentPropertyPreviewBase.prototype['is_tokuyuchin'] = undefined;

/**
 * @member {Boolean} initial_cost_credit_card_available_flag
 */
RentPropertyPreviewBase.prototype['initial_cost_credit_card_available_flag'] = undefined;

/**
 * @member {Boolean} monthly_cost_credit_card_available_flag
 */
RentPropertyPreviewBase.prototype['monthly_cost_credit_card_available_flag'] = undefined;

/**
 * @member {Boolean} other_initial_cost_free_flag
 */
RentPropertyPreviewBase.prototype['other_initial_cost_free_flag'] = undefined;

/**
 * @member {String} manage_cost_free
 */
RentPropertyPreviewBase.prototype['manage_cost_free'] = undefined;

/**
 * 0: 未入力<br/>1: 有<br/>2: 無<br/>3: 実費
 * @member {Number} manage_cost_free_code
 */
RentPropertyPreviewBase.prototype['manage_cost_free_code'] = undefined;

/**
 * @member {String} service_fee_free
 */
RentPropertyPreviewBase.prototype['service_fee_free'] = undefined;

/**
 * 0: 未入力<br/>1: 有<br/>2: 無<br/>3: 実費
 * @member {Number} service_fee_free_code
 */
RentPropertyPreviewBase.prototype['service_fee_free_code'] = undefined;

/**
 * @member {String} misc_expense_free
 */
RentPropertyPreviewBase.prototype['misc_expense_free'] = undefined;

/**
 * 0: 未入力<br/>1: 有<br/>2: 無<br/>3: 実費
 * @member {Number} misc_expense_free_code
 */
RentPropertyPreviewBase.prototype['misc_expense_free_code'] = undefined;
 ...
 * @default false
 */
RentPropertyPreviewBase.prototype['no_guarantor_flag'] = false;

/**
 * @member {String} guarantor_requirements
 */
RentPropertyPreviewBase.prototype['guarantor_requirements'] = undefined;
 ...
 * @default 3
 */
RentPropertyPreviewBase.prototype['guarantor_requirements_code'] = 3;

/**
 * @member {String} initial_cost
 */
RentPropertyPreviewBase.prototype['initial_cost'] = undefined;
 ...
 * @default 99
 */
RentPropertyPreviewBase.prototype['initial_cost_code'] = 99;

/**
 * @member {String} student_restriction
 */
RentPropertyPreviewBase.prototype['student_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談<br/>4: 限定<br/>5: 希望<br/>6: 歓迎
 * @member {Number} student_restriction_code
 */
RentPropertyPreviewBase.prototype['student_restriction_code'] = undefined;

/**
 * @member {String} gender_restriction
 */
RentPropertyPreviewBase.prototype['gender_restriction'] = undefined;

/**
 * 1: 不問<br/>2: 女性限定<br/>3: 男性限定<br/>4: 女性希望<br/>5: 男性希望
 * @member {Number} gender_restriction_code
 */
RentPropertyPreviewBase.prototype['gender_restriction_code'] = undefined;

/**
 * @member {String} kids_restriction
 */
RentPropertyPreviewBase.prototype['kids_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} kids_restriction_code
 */
RentPropertyPreviewBase.prototype['kids_restriction_code'] = undefined;

/**
 * @member {String} one_person_restriction
 */
RentPropertyPreviewBase.prototype['one_person_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談<br/>4: 限定<br/>5: 希望
 * @member {Number} one_person_restriction_code
 */
RentPropertyPreviewBase.prototype['one_person_restriction_code'] = undefined;

/**
 * @member {String} two_persons_restriction
 */
RentPropertyPreviewBase.prototype['two_persons_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談<br/>4: 限定<br/>5: 希望<br/>6: 歓迎
 * @member {Number} two_persons_restriction_code
 */
RentPropertyPreviewBase.prototype['two_persons_restriction_code'] = undefined;

/**
 * @member {String} elder_restriction
 */
RentPropertyPreviewBase.prototype['elder_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談<br/>4: 限定<br/>5: 希望<br/>6: 歓迎
 * @member {Number} elder_restriction_code
 */
RentPropertyPreviewBase.prototype['elder_restriction_code'] = undefined;

/**
 * @member {String} corporate_contract_restriction
 */
RentPropertyPreviewBase.prototype['corporate_contract_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談<br/>4: 限定<br/>5: 希望
 * @member {Number} corporate_contract_restriction_code
 */
RentPropertyPreviewBase.prototype['corporate_contract_restriction_code'] = undefined;

/**
 * @member {String} pet_restriction
 */
RentPropertyPreviewBase.prototype['pet_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} pet_restriction_code
 */
RentPropertyPreviewBase.prototype['pet_restriction_code'] = undefined;

/**
 * @member {String} office_usage_restriction
 */
RentPropertyPreviewBase.prototype['office_usage_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} office_usage_restriction_code
 */
RentPropertyPreviewBase.prototype['office_usage_restriction_code'] = undefined;

/**
 * @member {String} musical_instrument_restriction
 */
RentPropertyPreviewBase.prototype['musical_instrument_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} musical_instrument_restriction_code
 */
RentPropertyPreviewBase.prototype['musical_instrument_restriction_code'] = undefined;

/**
 * @member {String} restaurant_usage_restriction
 */
RentPropertyPreviewBase.prototype['restaurant_usage_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} restaurant_usage_restriction_code
 */
RentPropertyPreviewBase.prototype['restaurant_usage_restriction_code'] = undefined;

/**
 * @member {String} room_sharing_restriction
 */
RentPropertyPreviewBase.prototype['room_sharing_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} room_sharing_restriction_code
 */
RentPropertyPreviewBase.prototype['room_sharing_restriction_code'] = undefined;

/**
 * @member {String} foreigner_restriction
 */
RentPropertyPreviewBase.prototype['foreigner_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} foreigner_restriction_code
 */
RentPropertyPreviewBase.prototype['foreigner_restriction_code'] = undefined;

/**
 * @member {String} friends_restriction
 */
RentPropertyPreviewBase.prototype['friends_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} friends_restriction_code
 */
RentPropertyPreviewBase.prototype['friends_restriction_code'] = undefined;

/**
 * @member {String} foreign_student_restriction
 */
RentPropertyPreviewBase.prototype['foreign_student_restriction'] = undefined;

/**
 * 1: 不可<br/>2: 可<br/>3: 相談
 * @member {Number} foreign_student_restriction_code
 */
RentPropertyPreviewBase.prototype['foreign_student_restriction_code'] = undefined;

/**
 * @member {String} deposit_for_student
 */
RentPropertyPreviewBase.prototype['deposit_for_student'] = undefined;

/**
 * 1: 不要<br/>2: 一ヶ月<br/>3: 二ヶ月
 * @member {Number} deposit_for_student_code
 */
RentPropertyPreviewBase.prototype['deposit_for_student_code'] = undefined;

/**
 * @member {String} dwelling_unit_use
 */
RentPropertyPreviewBase.prototype['dwelling_unit_use'] = undefined;

/**
 * 1: 住居<br/>2: 店舗<br/>3: 事務所<br/>4: 駐車場<br/>5: 駐輪場<br/>6: バイク置場<br/>7: 倉庫<br/>8: トランクルーム
 * @member {Number} dwelling_unit_use_code
 */
RentPropertyPreviewBase.prototype['dwelling_unit_use_code'] = undefined;

/**
 * @member {Number} room_count
 */
RentPropertyPreviewBase.prototype['room_count'] = undefined;

/**
 * @member {String} layout_type
 */
RentPropertyPreviewBase.prototype['layout_type'] = undefined;

/**
 * 1: R<br/>2: K<br/>3: DK<br/>4: SDK<br/>5: LDK<br/>6: SLDK<br/>7: LK<br/>8: SK<br/>9: SLK
 * @member {Number} layout_type_code
 */
RentPropertyPreviewBase.prototype['layout_type_code'] = undefined;

/**
 * `room_count` と `layout_type` を組み合わせて、一般的な間取りの文字列表現を返す。         ex) 1DK, 2LDK
 * @member {String} layout_text
 */
RentPropertyPreviewBase.prototype['layout_text'] = undefined;

/**
 * @member {String} orientation
 */
RentPropertyPreviewBase.prototype['orientation'] = undefined;

/**
 * 1: 東<br/>2: 西<br/>3: 南<br/>4: 北<br/>5: 北東<br/>6: 北西<br/>7: 南東<br/>8: 南西
 * @member {Number} orientation_code
 */
RentPropertyPreviewBase.prototype['orientation_code'] = undefined;

/**
 * @member {String} floor_number
 */
RentPropertyPreviewBase.prototype['floor_number'] = undefined;

/**
 * 専有面積 単位: 平方メートル 計測方法: 壁芯 内法 登記簿
 * @member {module:model/AreaWithMeasurementMethod} exclusive_area
 */
RentPropertyPreviewBase.prototype['exclusive_area'] = undefined;

/**
 * @member {String} available
 */
RentPropertyPreviewBase.prototype['available'] = undefined;

/**
 * 1: 即時<br/>2: 相談<br/>3: 期日指定<br/>4: 予定
 * @member {Number} available_code
 */
RentPropertyPreviewBase.prototype['available_code'] = undefined;

/**
 * 入居可能日／引渡可能日
 * @member {module:model/DateJun} available_datejun
 */
RentPropertyPreviewBase.prototype['available_datejun'] = undefined;

/**
 * @member {Date} departure_date
 */
RentPropertyPreviewBase.prototype['departure_date'] = undefined;

/**
 * @member {String} sales_point
 */
RentPropertyPreviewBase.prototype['sales_point'] = undefined;

/**
 * @member {String} website_comment
 */
RentPropertyPreviewBase.prototype['website_comment'] = undefined;

/**
 * @member {String} message_to_other_company
 */
RentPropertyPreviewBase.prototype['message_to_other_company'] = undefined;

/**
 * @member {String} original_property_code_text
 */
RentPropertyPreviewBase.prototype['original_property_code_text'] = undefined;

/**
 * @member {Boolean} advertise_flag
 */
RentPropertyPreviewBase.prototype['advertise_flag'] = undefined;

/**
 * @member {String} company_remark
 */
RentPropertyPreviewBase.prototype['company_remark'] = undefined;

/**
 * 広告料
 * @member {module:model/PriceWithUnit} advertising_fee
 */
RentPropertyPreviewBase.prototype['advertising_fee'] = undefined;

/**
 * 広告料更新日
 * @member {Date} advertising_fee_update_date
 */
RentPropertyPreviewBase.prototype['advertising_fee_update_date'] = undefined;

/**
 * @member {Number} customer_key
 */
RentPropertyPreviewBase.prototype['customer_key'] = undefined;

/**
 * @member {String} agent_guid
 */
RentPropertyPreviewBase.prototype['agent_guid'] = undefined;

/**
 * @member {String} staff_guid
 */
RentPropertyPreviewBase.prototype['staff_guid'] = undefined;

/**
 * @member {Array.<module:model/Transportation>} transportation
 */
RentPropertyPreviewBase.prototype['transportation'] = undefined;

/**
 * @member {String} parking_availability
 */
RentPropertyPreviewBase.prototype['parking_availability'] = undefined;

/**
 * 1: 無<br/>2: 有(敷地内)<br/>3: 付<br/>4: 近隣駐車場<br/>5: 空無<br/>6: 要問合せ
 * @member {Number} parking_availability_code
 */
RentPropertyPreviewBase.prototype['parking_availability_code'] = undefined;

/**
 * @member {Boolean} has_bike_parking
 */
RentPropertyPreviewBase.prototype['has_bike_parking'] = undefined;

/**
 * @member {Boolean} has_motorbike_parking
 */
RentPropertyPreviewBase.prototype['has_motorbike_parking'] = undefined;

/**
 * @member {module:model/IntRange} parking_price_range
 */
RentPropertyPreviewBase.prototype['parking_price_range'] = undefined;

/**
 * @member {Boolean} b2b_custom_flag
 */
RentPropertyPreviewBase.prototype['b2b_custom_flag'] = undefined;

/**
 * @member {String} b2b_free_comment
 */
RentPropertyPreviewBase.prototype['b2b_free_comment'] = undefined;

/**
 * @member {String} b2b_remark
 */
RentPropertyPreviewBase.prototype['b2b_remark'] = undefined;

/**
 * @member {Number} search_area
 */
RentPropertyPreviewBase.prototype['search_area'] = undefined;

/**
 * @member {module:model/RentPickupFeature} pickup_feature
 */
RentPropertyPreviewBase.prototype['pickup_feature'] = undefined;
...
export default RentPropertyPreviewBase;

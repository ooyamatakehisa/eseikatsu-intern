...
/**
 * The OtherInitialCost model module.
 * @module model/OtherInitialCost
 * @version 9.0.0
 */
class OtherInitialCost {
    /**
     * Constructs a new <code>OtherInitialCost</code>.
     * その他初期費用
     * @alias module:model/OtherInitialCost
     * @param otherInitialCost {module:model/Price} その他初期費用金額
     * @param otherInitialCostItem {String} 
     */
    constructor(otherInitialCost, otherInitialCostItem) { 
        
        OtherInitialCost.initialize(this, otherInitialCost, otherInitialCostItem);
    }
     ...
     */
    static initialize(obj, otherInitialCost, otherInitialCostItem) { 
        obj['other_initial_cost'] = otherInitialCost;
        obj['other_initial_cost_item'] = otherInitialCostItem;
    }

    /**
     * Constructs a <code>OtherInitialCost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OtherInitialCost} obj Optional instance to populate.
     * @return {module:model/OtherInitialCost} The populated <code>OtherInitialCost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OtherInitialCost();

            if (data.hasOwnProperty('other_initial_cost')) {
                obj['other_initial_cost'] = ApiClient.convertToType(data['other_initial_cost'], Price);
            }
            if (data.hasOwnProperty('other_initial_cost_item')) {
                obj['other_initial_cost_item'] = ApiClient.convertToType(data['other_initial_cost_item'], 'String');
            }
            if (data.hasOwnProperty('other_initial_cost_comment')) {
                obj['other_initial_cost_comment'] = ApiClient.convertToType(data['other_initial_cost_comment'], 'String');
            }
        }
        return obj;
    }
...
/**
 * その他初期費用金額
 * @member {module:model/Price} other_initial_cost
 */
OtherInitialCost.prototype['other_initial_cost'] = undefined;

/**
 * @member {String} other_initial_cost_item
 */
OtherInitialCost.prototype['other_initial_cost_item'] = undefined;

/**
 * @member {String} other_initial_cost_comment
 */
OtherInitialCost.prototype['other_initial_cost_comment'] = undefined;
...
export default OtherInitialCost;

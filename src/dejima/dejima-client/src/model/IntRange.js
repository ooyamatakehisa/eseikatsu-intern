    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('from_value')) {
                obj['from_value'] = ApiClient.convertToType(data['from_value'], 'Number');
            }
            if (data.hasOwnProperty('to_value')) {
                obj['to_value'] = ApiClient.convertToType(data['to_value'], 'Number');
            }
        }
        return obj;
    }
...
/**
 * @member {Number} from_value
 */
IntRange.prototype['from_value'] = undefined;

/**
 * @member {Number} to_value
 */
IntRange.prototype['to_value'] = undefined;

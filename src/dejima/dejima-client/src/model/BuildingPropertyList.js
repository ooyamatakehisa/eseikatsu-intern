...
import BuildingPropertyPreview from './BuildingPropertyPreview';

/**
 * The BuildingPropertyList model module.
 * @module model/BuildingPropertyList
 * @version 9.0.0
 */
class BuildingPropertyList {
    /**
     * Constructs a new <code>BuildingPropertyList</code>.
     * 賃貸物件概要一覧（建物・棟別表示）
     * @alias module:model/BuildingPropertyList
     * @param totalCounts {Number} 件数
     * @param startIndex {Number} 検索の開始インデックス
     * @param itemsPerPage {Number} ページあたりの最大表示数
     * @param results {Array.<module:model/BuildingPropertyPreview>} 棟表示物件概要
     */
    constructor(totalCounts, startIndex, itemsPerPage, results) { 
        
        BuildingPropertyList.initialize(this, totalCounts, startIndex, itemsPerPage, results);
    }
    ...
    /**
     * Constructs a <code>BuildingPropertyList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildingPropertyList} obj Optional instance to populate.
     * @return {module:model/BuildingPropertyList} The populated <code>BuildingPropertyList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildingPropertyList();
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [BuildingPropertyPreview]);
            }
        }
        return obj;
    }
 ...
 */
BuildingPropertyList.prototype['total_counts'] = undefined;

/**
 * 検索の開始インデックス
 * @member {Number} start_index
 */
BuildingPropertyList.prototype['start_index'] = undefined;

/**
 * ページあたりの最大表示数
 * @member {Number} items_per_page
 */
BuildingPropertyList.prototype['items_per_page'] = undefined;

/**
 * 棟表示物件概要
 * @member {Array.<module:model/BuildingPropertyPreview>} results
 */
BuildingPropertyList.prototype['results'] = undefined;
...
export default BuildingPropertyList;

...
/**
 * The DwellingUnitFeature model module.
 * @module model/DwellingUnitFeature
 * @version 9.0.0
 */
class DwellingUnitFeature {
    /**
     * Constructs a new <code>DwellingUnitFeature</code>.
     * 住戸特徴
     * @alias module:model/DwellingUnitFeature
     * @param featureCategoryName {String} 
     * @param featureName {Array.<String>} 
     */
    constructor(featureCategoryName, featureName) { 
        
        DwellingUnitFeature.initialize(this, featureCategoryName, featureName);
    }
     ...
     */
    static initialize(obj, featureCategoryName, featureName) { 
        obj['feature_category_name'] = featureCategoryName;
        obj['feature_name'] = featureName;
    }

    /**
     * Constructs a <code>DwellingUnitFeature</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DwellingUnitFeature} obj Optional instance to populate.
     * @return {module:model/DwellingUnitFeature} The populated <code>DwellingUnitFeature</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DwellingUnitFeature();

            if (data.hasOwnProperty('feature_category_name')) {
                obj['feature_category_name'] = ApiClient.convertToType(data['feature_category_name'], 'String');
            }
...
/**
 * @member {String} feature_category_name
 */
DwellingUnitFeature.prototype['feature_category_name'] = undefined;

/**
 * @member {Array.<String>} feature_name
 */
DwellingUnitFeature.prototype['feature_name'] = undefined;
...
export default DwellingUnitFeature;

...
import GeoAggregateElem from './GeoAggregateElem';

/**
 * The GeoAggregateResult model module.
 * @module model/GeoAggregateResult
 * @version 9.0.0
 */
class GeoAggregateResult {
    /**
     * Constructs a new <code>GeoAggregateResult</code>.
     * 緯度経度ブロック集計結果
     * @alias module:model/GeoAggregateResult
     * @param results {Array.<module:model/GeoAggregateElem>} 集計結果
     */
    constructor(results) { 
        
        GeoAggregateResult.initialize(this, results);
    }
    ...
    /**
     * Constructs a <code>GeoAggregateResult</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GeoAggregateResult} obj Optional instance to populate.
     * @return {module:model/GeoAggregateResult} The populated <code>GeoAggregateResult</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GeoAggregateResult();

            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [GeoAggregateElem]);
            }
        }
        return obj;
    }
...
/**
 * 集計結果
 * @member {Array.<module:model/GeoAggregateElem>} results
 */
GeoAggregateResult.prototype['results'] = undefined;
...
export default GeoAggregateResult;

...
class Agent {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('staff_comment')) {
                obj['staff_comment'] = ApiClient.convertToType(data['staff_comment'], 'String');
            }
        }
        return obj;
    }
...
/**
 * @member {String} staff_comment
 */
Agent.prototype['staff_comment'] = undefined;

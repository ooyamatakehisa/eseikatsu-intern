...
/**
 * The RentExternalUrl model module.
 * @module model/RentExternalUrl
 * @version 9.0.0
 */
class RentExternalUrl {
    /**
     * Constructs a new <code>RentExternalUrl</code>.
     * 外部URL
     * @alias module:model/RentExternalUrl
     * @param urlCategoryCode {Number} 1: YouTube<br/>2: パノラマVR
     * @param url {String} 
     */
    constructor(urlCategoryCode, url) { 
        
        RentExternalUrl.initialize(this, urlCategoryCode, url);
    }
     ...
     */
    static initialize(obj, urlCategoryCode, url) { 
        obj['url_category_code'] = urlCategoryCode;
        obj['url'] = url;
    }

    /**
     * Constructs a <code>RentExternalUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RentExternalUrl} obj Optional instance to populate.
     * @return {module:model/RentExternalUrl} The populated <code>RentExternalUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RentExternalUrl();

            if (data.hasOwnProperty('url_category')) {
                obj['url_category'] = ApiClient.convertToType(data['url_category'], 'String');
            }
            if (data.hasOwnProperty('url_category_code')) {
                obj['url_category_code'] = ApiClient.convertToType(data['url_category_code'], 'Number');
            }
...
/**
 * @member {String} url_category
 */
RentExternalUrl.prototype['url_category'] = undefined;

/**
 * 1: YouTube<br/>2: パノラマVR
 * @member {Number} url_category_code
 */
RentExternalUrl.prototype['url_category_code'] = undefined;

/**
 * @member {String} url
 */
RentExternalUrl.prototype['url'] = undefined;
...
export default RentExternalUrl;

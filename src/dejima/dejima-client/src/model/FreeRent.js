...
/**
 * The FreeRent model module.
 * @module model/FreeRent
 * @version 9.0.0
 */
class FreeRent {
    /**
     * Constructs a new <code>FreeRent</code>.
     * フリーレント
     * @alias module:model/FreeRent
     */
    constructor() { 
        
        FreeRent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FreeRent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FreeRent} obj Optional instance to populate.
     * @return {module:model/FreeRent} The populated <code>FreeRent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FreeRent();

            if (data.hasOwnProperty('free_rent_term')) {
                obj['free_rent_term'] = ApiClient.convertToType(data['free_rent_term'], 'Number');
            }
            if (data.hasOwnProperty('free_rent_period_datejun')) {
                obj['free_rent_period_datejun'] = ApiClient.convertToType(data['free_rent_period_datejun'], DateJun);
            }
            if (data.hasOwnProperty('free_rent_condition')) {
                obj['free_rent_condition'] = ApiClient.convertToType(data['free_rent_condition'], 'String');
            }
        }
        return obj;
    }
...
/**
 * @member {Number} free_rent_term
 */
FreeRent.prototype['free_rent_term'] = undefined;

/**
 * フリーレント期日
 * @member {module:model/DateJun} free_rent_period_datejun
 */
FreeRent.prototype['free_rent_period_datejun'] = undefined;

/**
 * @member {String} free_rent_condition
 */
FreeRent.prototype['free_rent_condition'] = undefined;

...
class DwellingUnit {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('layout_comment')) {
                obj['layout_comment'] = ApiClient.convertToType(data['layout_comment'], 'String');
            }
            ...
            if (data.hasOwnProperty('land_share_rate_denom')) {
                obj['land_share_rate_denom'] = ApiClient.convertToType(data['land_share_rate_denom'], 'Number');
            }
            if (data.hasOwnProperty('land_share_rate_numer')) {
                obj['land_share_rate_numer'] = ApiClient.convertToType(data['land_share_rate_numer'], 'Number');
            }
            if (data.hasOwnProperty('basement_area')) {
                obj['basement_area'] = ApiClient.convertToType(data['basement_area'], 'Number');
            }
        }
        return obj;
    }
...
/**
 * @member {String} layout_comment
 */
DwellingUnit.prototype['layout_comment'] = undefined;
...
/**
 * @member {Number} land_share_rate_denom
 */
DwellingUnit.prototype['land_share_rate_denom'] = undefined;

/**
 * @member {Number} land_share_rate_numer
 */
DwellingUnit.prototype['land_share_rate_numer'] = undefined;

/**
 * @member {Number} basement_area
 */
DwellingUnit.prototype['basement_area'] = undefined;

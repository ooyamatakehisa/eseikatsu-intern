...
/**
 * The AreaAggregateElem model module.
 * @module model/AreaAggregateElem
 * @version 9.0.0
 */
class AreaAggregateElem {
    /**
     * Constructs a new <code>AreaAggregateElem</code>.
     * エリア別集計小計
     * @alias module:model/AreaAggregateElem
     * @param count {Number} 物件数
     * @param prefecture {String} 都道府県
     * @param prefectureCode {Number} 都道府県コード
     */
    constructor(count, prefecture, prefectureCode) { 
        
        AreaAggregateElem.initialize(this, count, prefecture, prefectureCode);
    }
     ...
     */
    static initialize(obj, count, prefecture, prefectureCode) { 
        obj['count'] = count;
    ...
    /**
     * Constructs a <code>AreaAggregateElem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AreaAggregateElem} obj Optional instance to populate.
     * @return {module:model/AreaAggregateElem} The populated <code>AreaAggregateElem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AreaAggregateElem();
 ...
 * @member {Number} count
 */
AreaAggregateElem.prototype['count'] = undefined;

/**
 * ドリルダウン用クエリパラメータ
 * @member {String} query
 */
AreaAggregateElem.prototype['query'] = undefined;

/**
 * 都道府県
 * @member {String} prefecture
 */
AreaAggregateElem.prototype['prefecture'] = undefined;

/**
 * 都道府県コード
 * @member {Number} prefecture_code
 */
AreaAggregateElem.prototype['prefecture_code'] = undefined;

/**
 * 市区群
 * @member {String} city
 */
AreaAggregateElem.prototype['city'] = undefined;

/**
 * 市区郡コード
 * @member {Number} city_code
 */
AreaAggregateElem.prototype['city_code'] = undefined;

/**
 * 町村
 * @member {String} town
 */
AreaAggregateElem.prototype['town'] = undefined;
...
export default AreaAggregateElem;

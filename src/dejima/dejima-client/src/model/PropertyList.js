...
import RentPropertyPreview from './RentPropertyPreview';
...
class PropertyList {
     ...
     * @param results {Array.<module:model/RentPropertyPreview>} 物件概要
     */
    constructor(totalCounts, startIndex, itemsPerPage, results) { 
        
        PropertyList.initialize(this, totalCounts, startIndex, itemsPerPage, results);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('results')) {
                obj['results'] = ApiClient.convertToType(data['results'], [RentPropertyPreview]);
            }
        }
        return obj;
    }
 ...
 */
PropertyList.prototype['total_counts'] = undefined;

/**
 * 検索の開始インデックス
 * @member {Number} start_index
 */
PropertyList.prototype['start_index'] = undefined;

/**
 * ページあたりの最大表示数
 * @member {Number} items_per_page
 */
PropertyList.prototype['items_per_page'] = undefined;

/**
 * 物件概要
 * @member {Array.<module:model/RentPropertyPreview>} results
 */
PropertyList.prototype['results'] = undefined;

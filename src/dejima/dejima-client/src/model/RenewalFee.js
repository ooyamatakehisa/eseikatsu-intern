...
/**
 * The RenewalFee model module.
 * @module model/RenewalFee
 * @version 9.0.0
 */
class RenewalFee {
    /**
     * Constructs a new <code>RenewalFee</code>.
     * 更新料
     * @alias module:model/RenewalFee
     */
    constructor() { 
        
        RenewalFee.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RenewalFee</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RenewalFee} obj Optional instance to populate.
     * @return {module:model/RenewalFee} The populated <code>RenewalFee</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RenewalFee();

            if (data.hasOwnProperty('amount')) {
                obj['amount'] = ApiClient.convertToType(data['amount'], 'Number');
            }
            if (data.hasOwnProperty('is_tax_included')) {
                obj['is_tax_included'] = ApiClient.convertToType(data['is_tax_included'], 'Boolean');
            }
            if (data.hasOwnProperty('is_non_taxable')) {
                obj['is_non_taxable'] = ApiClient.convertToType(data['is_non_taxable'], 'Boolean');
            }
            if (data.hasOwnProperty('unit')) {
                obj['unit'] = ApiClient.convertToType(data['unit'], 'String');
            }
            if (data.hasOwnProperty('renewal_fee_class')) {
                obj['renewal_fee_class'] = ApiClient.convertToType(data['renewal_fee_class'], 'String');
            }
            if (data.hasOwnProperty('renewal_fee_class_code')) {
                obj['renewal_fee_class_code'] = ApiClient.convertToType(data['renewal_fee_class_code'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
RenewalFee.prototype['amount'] = undefined;

/**
 * @member {Boolean} is_tax_included
 */
RenewalFee.prototype['is_tax_included'] = undefined;

/**
 * @member {Boolean} is_non_taxable
 */
RenewalFee.prototype['is_non_taxable'] = undefined;

/**
 * @member {String} unit
 */
RenewalFee.prototype['unit'] = undefined;

/**
 * @member {String} renewal_fee_class
 */
RenewalFee.prototype['renewal_fee_class'] = undefined;

/**
 * 1: 新賃料<br/>2: 旧賃料
 * @member {Number} renewal_fee_class_code
 */
RenewalFee.prototype['renewal_fee_class_code'] = undefined;

...
/**
 * The OtherMonthlyCost model module.
 * @module model/OtherMonthlyCost
 * @version 9.0.0
 */
class OtherMonthlyCost {
    /**
     * Constructs a new <code>OtherMonthlyCost</code>.
     * その他月次費用
     * @alias module:model/OtherMonthlyCost
     * @param otherMonthlyCost {module:model/Price} その他月次費用金額
     * @param otherMonthlyCostItem {String} 
     */
    constructor(otherMonthlyCost, otherMonthlyCostItem) { 
        
        OtherMonthlyCost.initialize(this, otherMonthlyCost, otherMonthlyCostItem);
    }
     ...
     */
    static initialize(obj, otherMonthlyCost, otherMonthlyCostItem) { 
        obj['other_monthly_cost'] = otherMonthlyCost;
        obj['other_monthly_cost_item'] = otherMonthlyCostItem;
    }

    /**
     * Constructs a <code>OtherMonthlyCost</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OtherMonthlyCost} obj Optional instance to populate.
     * @return {module:model/OtherMonthlyCost} The populated <code>OtherMonthlyCost</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OtherMonthlyCost();

            if (data.hasOwnProperty('other_monthly_cost')) {
                obj['other_monthly_cost'] = ApiClient.convertToType(data['other_monthly_cost'], Price);
            }
            if (data.hasOwnProperty('other_monthly_cost_item')) {
                obj['other_monthly_cost_item'] = ApiClient.convertToType(data['other_monthly_cost_item'], 'String');
            }
        }
        return obj;
    }
...
/**
 * その他月次費用金額
 * @member {module:model/Price} other_monthly_cost
 */
OtherMonthlyCost.prototype['other_monthly_cost'] = undefined;

/**
 * @member {String} other_monthly_cost_item
 */
OtherMonthlyCost.prototype['other_monthly_cost_item'] = undefined;
...
export default OtherMonthlyCost;

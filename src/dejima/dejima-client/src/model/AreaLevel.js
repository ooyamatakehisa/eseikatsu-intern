...
* @readonly
*/
export default class AreaLevel {
    ...
    /**
    * Returns a <code>AreaLevel</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AreaLevel} The enum <code>AreaLevel</code> value.
    */

    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('station_code')) {
                obj['station_code'] = ApiClient.convertToType(data['station_code'], 'String');
            }
            ...
            if (data.hasOwnProperty('line_code')) {
                obj['line_code'] = ApiClient.convertToType(data['line_code'], 'String');
            }
            if (data.hasOwnProperty('line_name')) {
                obj['line_name'] = ApiClient.convertToType(data['line_name'], 'String');
            }
...
/**
 * @member {String} station_code
 */
Station.prototype['station_code'] = undefined;

/**
 * @member {String} station_name
 */
Station.prototype['station_name'] = undefined;

/**
 * @member {String} line_code
 */
Station.prototype['line_code'] = undefined;

/**
 * @member {String} line_name
 */
Station.prototype['line_name'] = undefined;

/**
 * @member {String} company_name
 */
Station.prototype['company_name'] = undefined;

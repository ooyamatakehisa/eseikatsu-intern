...
class Room {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('area_unit_code')) {
                obj['area_unit_code'] = ApiClient.convertToType(data['area_unit_code'], 'String');
            }
 ...
 * @member {Number} area
 */
Room.prototype['area'] = undefined;

/**
 * @member {String} area_unit
 */
Room.prototype['area_unit'] = undefined;

/**
 * 1: 畳<br/>2: ㎡
 * @member {String} area_unit_code
 */
Room.prototype['area_unit_code'] = undefined;

/**
 * @member {String} floor_number
 */
Room.prototype['floor_number'] = undefined;

/**
 * @member {String} kind
 */
Room.prototype['kind'] = undefined;

...
class RentPickupFeature {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('has_washstand')) {
                obj['has_washstand'] = ApiClient.convertToType(data['has_washstand'], 'Boolean');
            }
...
/**
 * @member {Boolean} has_washstand
 * @default false
 */
RentPickupFeature.prototype['has_washstand'] = false;

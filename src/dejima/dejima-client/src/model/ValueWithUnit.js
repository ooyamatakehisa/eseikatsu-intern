...
/**
 * The ValueWithUnit model module.
 * @module model/ValueWithUnit
 * @version 9.0.0
 */
class ValueWithUnit {
    /**
     * Constructs a new <code>ValueWithUnit</code>.
     * 単位付き整数
     * @alias module:model/ValueWithUnit
     */
    constructor() { 
        
        ValueWithUnit.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValueWithUnit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValueWithUnit} obj Optional instance to populate.
     * @return {module:model/ValueWithUnit} The populated <code>ValueWithUnit</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValueWithUnit();
 ...
 * @member {Number} value
 */
ValueWithUnit.prototype['value'] = undefined;

/**
 * @member {String} unit
 */
ValueWithUnit.prototype['unit'] = undefined;

...
/**
 * The TagDetail model module.
 * @module model/TagDetail
 * @version 9.0.0
 */
class TagDetail {
    /**
     * Constructs a new <code>TagDetail</code>.
     * タグ詳細
     * @alias module:model/TagDetail
     * @param tagGuid {String} 
     */
    constructor(tagGuid) { 
        
        TagDetail.initialize(this, tagGuid);
    }
     ...
     */
    static initialize(obj, tagGuid) { 
        obj['tag_guid'] = tagGuid;
    }

    /**
     * Constructs a <code>TagDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TagDetail} obj Optional instance to populate.
     * @return {module:model/TagDetail} The populated <code>TagDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagDetail();

            if (data.hasOwnProperty('tag_guid')) {
                obj['tag_guid'] = ApiClient.convertToType(data['tag_guid'], 'String');
            }
            ...
            if (data.hasOwnProperty('tag_group_name')) {
                obj['tag_group_name'] = ApiClient.convertToType(data['tag_group_name'], 'String');
            }
        }
        return obj;
    }
...
/**
 * @member {String} tag_guid
 */
TagDetail.prototype['tag_guid'] = undefined;

/**
 * @member {String} tag_name
 */
TagDetail.prototype['tag_name'] = undefined;

/**
 * @member {String} color
 */
TagDetail.prototype['color'] = undefined;

/**
 * @member {String} tag_group_name
 */
TagDetail.prototype['tag_group_name'] = undefined;

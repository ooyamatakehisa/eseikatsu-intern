...
/**
 * The RentPeriod model module.
 * @module model/RentPeriod
 * @version 9.0.0
 */
class RentPeriod {
    /**
     * Constructs a new <code>RentPeriod</code>.
     * 賃貸契約期間
     * @alias module:model/RentPeriod
     */
    constructor() { 
        
        RentPeriod.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RentPeriod</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RentPeriod} obj Optional instance to populate.
     * @return {module:model/RentPeriod} The populated <code>RentPeriod</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RentPeriod();
            ...
            if (data.hasOwnProperty('contract_term')) {
                obj['contract_term'] = ApiClient.convertToType(data['contract_term'], ValueWithUnit);
            }
            if (data.hasOwnProperty('contract_end_datejun')) {
                obj['contract_end_datejun'] = ApiClient.convertToType(data['contract_end_datejun'], DateJun);
            }
        }
        return obj;
    }
 ...
 */
RentPeriod.prototype['residence_rent_period'] = undefined;

/**
 * 1: 普通借家契約<br/>2: 定期借家契約
 * @member {Number} residence_rent_period_code
 */
RentPeriod.prototype['residence_rent_period_code'] = undefined;

/**
 * @member {module:model/ValueWithUnit} contract_term
 */
RentPeriod.prototype['contract_term'] = undefined;

/**
 * 契約期日
 * @member {module:model/DateJun} contract_end_datejun
 */
RentPeriod.prototype['contract_end_datejun'] = undefined;

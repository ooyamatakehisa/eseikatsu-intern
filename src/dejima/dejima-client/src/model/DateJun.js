...
/**
 * The DateJun model module.
 * @module model/DateJun
 * @version 9.0.0
 */
class DateJun {
    /**
     * Constructs a new <code>DateJun</code>.
     * 年月旬日
     * @alias module:model/DateJun
     * @param value {Number} 
     */
    constructor(value) { 
        
        DateJun.initialize(this, value);
    }
    ...
    /**
     * Constructs a <code>DateJun</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateJun} obj Optional instance to populate.
     * @return {module:model/DateJun} The populated <code>DateJun</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('jun')) {
                obj['jun'] = ApiClient.convertToType(data['jun'], 'Number');
            }
 ...
 * @member {Number} value
 */
DateJun.prototype['value'] = undefined;

/**
 * @member {Number} year
 */
DateJun.prototype['year'] = undefined;

/**
 * @member {Number} month
 */
DateJun.prototype['month'] = undefined;

/**
 * @member {Number} jun
 * @default 0
 */
DateJun.prototype['jun'] = 0;

/**
 * @member {Number} day
 */
DateJun.prototype['day'] = undefined;

/**
 * @member {String} text
 */
DateJun.prototype['text'] = undefined;

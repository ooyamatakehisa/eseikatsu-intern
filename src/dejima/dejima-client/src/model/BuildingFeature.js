...
/**
 * The BuildingFeature model module.
 * @module model/BuildingFeature
 * @version 9.0.0
 */
class BuildingFeature {
    /**
     * Constructs a new <code>BuildingFeature</code>.
     * 建物特徴
     * @alias module:model/BuildingFeature
     * @param featureCategoryName {String} 
     * @param featureName {Array.<String>} 
     */
    constructor(featureCategoryName, featureName) { 
        
        BuildingFeature.initialize(this, featureCategoryName, featureName);
    }
    ...
    /**
     * Constructs a <code>BuildingFeature</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BuildingFeature} obj Optional instance to populate.
     * @return {module:model/BuildingFeature} The populated <code>BuildingFeature</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BuildingFeature();
 ...
 */
BuildingFeature.prototype['feature_category_name'] = undefined;

/**
 * @member {Array.<String>} feature_name
 */
BuildingFeature.prototype['feature_name'] = undefined;

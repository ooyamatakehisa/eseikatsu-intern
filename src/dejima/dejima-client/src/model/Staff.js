...
class Staff {
     ...
     * @param staffGuid {String} 
     * @param customerKey {Number} 
     * @param staffName {String} 
     */
    constructor(staffGuid, customerKey, staffName) { 
        
        Staff.initialize(this, staffGuid, customerKey, staffName);
    }
     ...
     */
    static initialize(obj, staffGuid, customerKey, staffName) { 
        obj['staff_guid'] = staffGuid;
        obj['customer_key'] = customerKey;
        obj['staff_name'] = staffName;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('staff_name')) {
                obj['staff_name'] = ApiClient.convertToType(data['staff_name'], 'String');
            }
            if (data.hasOwnProperty('staff_image_guid')) {
                obj['staff_image_guid'] = ApiClient.convertToType(data['staff_image_guid'], 'String');
            }
        }
        return obj;
    }
 ...
 */
Staff.prototype['staff_guid'] = undefined;

/**
 * @member {Number} customer_key
 */
Staff.prototype['customer_key'] = undefined;

/**
 * @member {String} staff_name
 */
Staff.prototype['staff_name'] = undefined;

/**
 * @member {String} staff_image_guid
 */
Staff.prototype['staff_image_guid'] = undefined;

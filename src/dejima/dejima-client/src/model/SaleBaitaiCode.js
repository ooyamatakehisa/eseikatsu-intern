...
/**
* Enum class SaleBaitaiCode.
* @enum {}
* @readonly
*/
export default class SaleBaitaiCode {
    ...
    /**
    * Returns a <code>SaleBaitaiCode</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SaleBaitaiCode} The enum <code>SaleBaitaiCode</code> value.
    */

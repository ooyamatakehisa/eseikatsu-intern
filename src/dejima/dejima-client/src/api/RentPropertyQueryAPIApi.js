...
import GeoAggregateResult from '../model/GeoAggregateResult';
import HTTPValidationError from '../model/HTTPValidationError';
import LineAggregateResult from '../model/LineAggregateResult';
import LineLevel from '../model/LineLevel';
import Order from '../model/Order';
import PropertyCountResult from '../model/PropertyCountResult';
...
export default class RentPropertyQueryAPIApi {
    ...
    */
     ...
     * @param {Number} latitudeFrom 緯度(世界測地系)検索区間（DEG形式。単位:ミリ秒）
     * @param {Number} latitudeTo 緯度(世界測地系)検索区間（DEG形式。単位:ミリ秒）
     * @param {Number} longitudeFrom 経度(世界測地系)検索区間（DEG形式。単位:ミリ秒）
     * @param {Number} longitudeTo 経度(世界測地系)検索区間（DEG形式。単位:ミリ秒）
     * @param {Number} geoBlockSize 集計ブロックのサイズ（DEG形式。単位:ミリ秒） 緯度経度検索範囲より大きな値を指定した場合は緯度区間と経度区間の小さい方をブロックサイズにして集計する
     ...
     * @param {Array.<Number>} opts.layoutCode 間取り区分<br/>1: 1R<br/>2: 1K<br/>3: 1DK<br/>4: 1LDK<br/>5: 2K<br/>6: 2DK<br/>7: 2LDK<br/>8: 3K<br/>9: 3DK<br/>10: 3LDK<br/>11: 4K<br/>12: 4DK<br/>13: 4LDK<br/>14: 5K以上<br/>15: 4LDK以上
     ...
     * @param {Array.<Number>} opts.internetEquipmentCode インターネット設備区分<br/>1: ADSL<br/>2: CATVインターネット<br/>3: ISDN対応<br/>4: インターネット専用線配線済み<br/>5: インターネット専用線各部屋配線済み<br/>6: 光ファイバー
     ...
     * @param {Boolean} opts.initialCostCreditCardAvailableFlag 入居時費用クレジットカード決済可能フラグ
     * @param {Boolean} opts.monthlyCostCreditCardAvailableFlag 入居後の賃料等クレジットカード決済可能フラグ
     ...
     * @param {Boolean} opts.hasWashstand 洗面台
     * @param {Boolean} opts.hasBrokerageFee 仲介手数料有り
     ...
     * @param {Array.<String>} opts.tagGuidAnd タグGUID(and検索)
     * @param {String} opts.zipcode 建物郵便番号
     * @param {String} opts.prefecture 都道府県
     * @param {Array.<Number>} opts.prefectureCode 都道府県コード
     * @param {Array.<Number>} opts.prefectureCodeNot 都道府県コード(not検索)
     * @param {Array.<String>} opts.city 市区郡
     * @param {Array.<Number>} opts.cityCode 市区郡コード
     * @param {Array.<Number>} opts.cityCodeNot 市区郡コード(not検索)
     * @param {Array.<String>} opts.town 町村
     * @param {Array.<Number>} opts.jisCode JISコード
     * @param {Array.<Number>} opts.jisCodeNot JISコード(not検索)
     * @param {Array.<String>} opts.address 住所
     * @param {Array.<String>} opts.addressNot 住所(not検索)
     * @param {Array.<Number>} opts.lineCode 沿線コード
     * @param {Array.<Number>} opts.lineCodeNot 沿線コード(沿線上の駅のnot検索)
     * @param {Array.<Number>} opts.stationCode 駅コード
     * @param {Array.<Number>} opts.stationCodeNot 駅コード(not検索)
     * @param {Boolean} opts.relaxStationAccessCond 指定された沿線/駅以外の登録駅が徒歩時間を満たす場合も許す (default to false)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GeoAggregateResult} and HTTP response
     */
    aggregareRentPropertyByGeoWithHttpInfo(latitudeFrom, latitudeTo, longitudeFrom, longitudeTo, geoBlockSize, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'latitudeFrom' is set
      if (latitudeFrom === undefined || latitudeFrom === null) {
        throw new Error("Missing the required parameter 'latitudeFrom' when calling aggregareRentPropertyByGeo");
      }
      // verify the required parameter 'latitudeTo' is set
      if (latitudeTo === undefined || latitudeTo === null) {
        throw new Error("Missing the required parameter 'latitudeTo' when calling aggregareRentPropertyByGeo");
      }
      // verify the required parameter 'longitudeFrom' is set
      if (longitudeFrom === undefined || longitudeFrom === null) {
        throw new Error("Missing the required parameter 'longitudeFrom' when calling aggregareRentPropertyByGeo");
      }
      // verify the required parameter 'longitudeTo' is set
      if (longitudeTo === undefined || longitudeTo === null) {
        throw new Error("Missing the required parameter 'longitudeTo' when calling aggregareRentPropertyByGeo");
      }
      // verify the required parameter 'geoBlockSize' is set
      if (geoBlockSize === undefined || geoBlockSize === null) {
        throw new Error("Missing the required parameter 'geoBlockSize' when calling aggregareRentPropertyByGeo");
      }
      ...
      let queryParams = {
        ...
        'internet_equipment_code': this.apiClient.buildCollectionParam(opts['internetEquipmentCode'], 'multi'),
        ...
        'initial_cost_credit_card_available_flag': opts['initialCostCreditCardAvailableFlag'],
        'monthly_cost_credit_card_available_flag': opts['monthlyCostCreditCardAvailableFlag'],
        ...
        'has_washstand': opts['hasWashstand'],
        'has_brokerage_fee': opts['hasBrokerageFee'],
        ...
        'latitude.from': latitudeFrom,
        'latitude.to': latitudeTo,
        'longitude.from': longitudeFrom,
        'longitude.to': longitudeTo,
        'tag_guid': this.apiClient.buildCollectionParam(opts['tagGuid'], 'multi'),
        'tag_guid.and': this.apiClient.buildCollectionParam(opts['tagGuidAnd'], 'multi'),
        'zipcode': opts['zipcode'],
        'prefecture': opts['prefecture'],
        'prefecture_code': this.apiClient.buildCollectionParam(opts['prefectureCode'], 'multi'),
        'prefecture_code.not': this.apiClient.buildCollectionParam(opts['prefectureCodeNot'], 'multi'),
        ...
        'city_code.not': this.apiClient.buildCollectionParam(opts['cityCodeNot'], 'multi'),
        'town': this.apiClient.buildCollectionParam(opts['town'], 'multi'),
        'jis_code': this.apiClient.buildCollectionParam(opts['jisCode'], 'multi'),
        'jis_code.not': this.apiClient.buildCollectionParam(opts['jisCodeNot'], 'multi'),
        'address': this.apiClient.buildCollectionParam(opts['address'], 'multi'),
        'address.not': this.apiClient.buildCollectionParam(opts['addressNot'], 'multi'),
        'line_code': this.apiClient.buildCollectionParam(opts['lineCode'], 'multi'),
        'line_code.not': this.apiClient.buildCollectionParam(opts['lineCodeNot'], 'multi'),
        'station_code': this.apiClient.buildCollectionParam(opts['stationCode'], 'multi'),
        'station_code.not': this.apiClient.buildCollectionParam(opts['stationCodeNot'], 'multi'),
        'relax_station_access_cond': opts['relaxStationAccessCond'],
      ...
      let returnType = GeoAggregateResult;
      return this.apiClient.callApi(
        '/property/rent/geo/count/', 'GET',
     ...
     * @param {Boolean} opts.ignoreNameDisplay 建物名/物件名フリガナでの検索時はデフォルトでは建物名表示フラグがfalseの物件は対象にしない。このフラグを有効化すると表示フラグに関わらず検索対象になる
     * @param {String} opts.query 詳細検索用特殊パラメータ。検索条件を JSON で記載し、エンコードしたものを     バリューに渡す。          ex) '[{\"building_name\": \"いい生活アパート\", \"price.to\": 700000}, {\"buildinig_name\": \"いい生活ハイツ\", \"walk_from_station_minutes.to\": 10}]'     -> ?query=%5B%7B%22building_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%82%A2%E3%83%91%E3%83%BC%E3%83%88%22%2C%20%22price.to%22%3A%20700000%7D%2C%20%7B%22buildinig_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%83%8F%E3%82%A4%E3%83%84%22%2C%20%22walk_from_station_minutes.to%22%3A%2010%7D%5D          上記の例の場合の絞り込み条件は、抽象的に書き下すと次のようになる。          (building_name like \"%いい生活アパート%\" AND price <= 700000) OR (building_name like \"%いい生活ハイツ%\" AND walk_from_station_minutes <= 10)     
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GeoAggregateResult}
     */
    aggregareRentPropertyByGeo(latitudeFrom, latitudeTo, longitudeFrom, longitudeTo, geoBlockSize, opts) {
      return this.aggregareRentPropertyByGeoWithHttpInfo(latitudeFrom, latitudeTo, longitudeFrom, longitudeTo, geoBlockSize, opts)
     ...
     * @param {String} opts.buildingName 建物名
     * @param {String} opts.buildingFurigana 建物名フリガナ
     * @param {Number} opts.latitudeFrom 緯度(世界測地系)検索区間（ミリ秒で指定）
     * @param {Number} opts.latitudeTo 緯度(世界測地系)検索区間（ミリ秒で指定）
     * @param {Number} opts.longitudeFrom 経度(世界測地系)検索区間（ミリ秒で指定）
     * @param {Number} opts.longitudeTo 経度(世界測地系)検索区間（ミリ秒で指定）
     * @param {Array.<String>} opts.tagGuid タグGUID
     * @param {Array.<String>} opts.tagGuidAnd タグGUID(and検索)
     * @param {String} opts.zipcode 建物郵便番号
     * @param {String} opts.prefecture 都道府県
     ...
     * @param {Boolean} opts.ignoreNameDisplay 建物名/物件名フリガナでの検索時はデフォルトでは建物名表示フラグがfalseの物件は対象にしない。このフラグを有効化すると表示フラグに関わらず検索対象になる
     * @param {String} opts.query 詳細検索用特殊パラメータ。検索条件を JSON で記載し、エンコードしたものを     バリューに渡す。          ex) '[{\"building_name\": \"いい生活アパート\", \"price.to\": 700000}, {\"buildinig_name\": \"いい生活ハイツ\", \"walk_from_station_minutes.to\": 10}]'     -> ?query=%5B%7B%22building_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%82%A2%E3%83%91%E3%83%BC%E3%83%88%22%2C%20%22price.to%22%3A%20700000%7D%2C%20%7B%22buildinig_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%83%8F%E3%82%A4%E3%83%84%22%2C%20%22walk_from_station_minutes.to%22%3A%2010%7D%5D          上記の例の場合の絞り込み条件は、抽象的に書き下すと次のようになる。          (building_name like \"%いい生活アパート%\" AND price <= 700000) OR (building_name like \"%いい生活ハイツ%\" AND walk_from_station_minutes <= 10)     
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PropertyCountResult} and HTTP response
     */
    countRentPropertyWithHttpInfo(opts) {
      opts = opts || {};
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PropertyCountResult;
      return this.apiClient.callApi(
        '/property/rent/dwelling_unit/count/', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @param {Boolean} opts.ignoreNameDisplay 建物名/物件名フリガナでの検索時はデフォルトでは建物名表示フラグがfalseの物件は対象にしない。このフラグを有効化すると表示フラグに関わらず検索対象になる
     * @param {String} opts.query 詳細検索用特殊パラメータ。検索条件を JSON で記載し、エンコードしたものを     バリューに渡す。          ex) '[{\"building_name\": \"いい生活アパート\", \"price.to\": 700000}, {\"buildinig_name\": \"いい生活ハイツ\", \"walk_from_station_minutes.to\": 10}]'     -> ?query=%5B%7B%22building_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%82%A2%E3%83%91%E3%83%BC%E3%83%88%22%2C%20%22price.to%22%3A%20700000%7D%2C%20%7B%22buildinig_name%22%3A%20%22%E3%81%84%E3%81%84%E7%94%9F%E6%B4%BB%E3%83%8F%E3%82%A4%E3%83%84%22%2C%20%22walk_from_station_minutes.to%22%3A%2010%7D%5D          上記の例の場合の絞り込み条件は、抽象的に書き下すと次のようになる。          (building_name like \"%いい生活アパート%\" AND price <= 700000) OR (building_name like \"%いい生活ハイツ%\" AND walk_from_station_minutes <= 10)     
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PropertyCountResult}
     */
    countRentProperty(opts) {
      return this.countRentPropertyWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

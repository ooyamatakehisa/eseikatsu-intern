...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.RentExternalUrl();
  });
  ...
  describe('RentExternalUrl', function() {
    it('should create an instance of RentExternalUrl', function() {
      // uncomment below and update the code to test RentExternalUrl
      //var instane = new EsApi.RentExternalUrl();
      //expect(instance).to.be.a(EsApi.RentExternalUrl);
    });

    it('should have the property urlCategory (base name: "url_category")', function() {
      // uncomment below and update the code to test the property urlCategory
      //var instane = new EsApi.RentExternalUrl();
      //expect(instance).to.be();
    });

    it('should have the property urlCategoryCode (base name: "url_category_code")', function() {
      // uncomment below and update the code to test the property urlCategoryCode
      //var instane = new EsApi.RentExternalUrl();
      //expect(instance).to.be();
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.GeoAggregateElem();
  });
  ...
  describe('GeoAggregateElem', function() {
    it('should create an instance of GeoAggregateElem', function() {
      // uncomment below and update the code to test GeoAggregateElem
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be.a(EsApi.GeoAggregateElem);
    });
    ...
    it('should have the property meanLatitude (base name: "mean_latitude")', function() {
      // uncomment below and update the code to test the property meanLatitude
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

    it('should have the property meanLongitude (base name: "mean_longitude")', function() {
      // uncomment below and update the code to test the property meanLongitude
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

    it('should have the property latitudeFrom (base name: "latitude_from")', function() {
      // uncomment below and update the code to test the property latitudeFrom
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

    it('should have the property latitudeTo (base name: "latitude_to")', function() {
      // uncomment below and update the code to test the property latitudeTo
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

    it('should have the property longitudeFrom (base name: "longitude_from")', function() {
      // uncomment below and update the code to test the property longitudeFrom
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

    it('should have the property longitudeTo (base name: "longitude_to")', function() {
      // uncomment below and update the code to test the property longitudeTo
      //var instane = new EsApi.GeoAggregateElem();
      //expect(instance).to.be();
    });

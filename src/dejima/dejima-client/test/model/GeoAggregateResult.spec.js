...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.GeoAggregateResult();
  });
  ...
  describe('GeoAggregateResult', function() {
    it('should create an instance of GeoAggregateResult', function() {
      // uncomment below and update the code to test GeoAggregateResult
      //var instane = new EsApi.GeoAggregateResult();
      //expect(instance).to.be.a(EsApi.GeoAggregateResult);
    });

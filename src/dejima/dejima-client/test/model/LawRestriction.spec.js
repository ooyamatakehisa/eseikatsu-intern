...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.LawRestriction();
  });
  ...
  describe('LawRestriction', function() {
    it('should create an instance of LawRestriction', function() {
      // uncomment below and update the code to test LawRestriction
      //var instane = new EsApi.LawRestriction();
      //expect(instance).to.be.a(EsApi.LawRestriction);
    });

    it('should have the property lawRestriction (base name: "law_restriction")', function() {
      // uncomment below and update the code to test the property lawRestriction
      //var instane = new EsApi.LawRestriction();
      //expect(instance).to.be();
    });

    it('should have the property lawRestrictionCode (base name: "law_restriction_code")', function() {
      // uncomment below and update the code to test the property lawRestrictionCode
      //var instane = new EsApi.LawRestriction();
      //expect(instance).to.be();
    });

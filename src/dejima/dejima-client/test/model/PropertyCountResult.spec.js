...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsApi.PropertyCountResult();
  });
  ...
  describe('PropertyCountResult', function() {
    it('should create an instance of PropertyCountResult', function() {
      // uncomment below and update the code to test PropertyCountResult
      //var instane = new EsApi.PropertyCountResult();
      //expect(instance).to.be.a(EsApi.PropertyCountResult);
    });

    it('should have the property totalCounts (base name: "total_counts")', function() {
      // uncomment below and update the code to test the property totalCounts
      //var instane = new EsApi.PropertyCountResult();
